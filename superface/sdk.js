...
var typeDefinitions = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, send_sms_1.communicationSendSms), user_repos_1.vcsUserRepos), pull_requests_1.vcsPullRequests), single_file_content_1.vcsSingleFileContent), clean_address_1.addressCleanAddress), send_email_1.communicationSendEmail), send_templated_email_1.communicationSendTemplatedEmail), character_information_1.starwarsCharacterInformation), pull_request_1.vcsPullRequest), geocoding_1.addressGeocoding), shipment_info_1.deliveryTrackingShipmentInfo), email_templates_1.communicationEmailTemplates), send_message_1.communicationSendMessage), current_city_1.weatherCurrentCity), synthesis_1.speechSynthesis), face_detection_1.computerVisionFaceDetection), exchange_rate_1.cryptoExchangeRate), contacts_1.crmContacts), analyze_plain_text_sentiment_1.translationAnalyzePlainTextSentiment);
