...
var face_detection_1 = require("./types/identity/face-detection");
...
var typeDefinitions = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, clean_address_1.addressCleanAddress), geocoding_1.addressGeocoding), email_templates_1.communicationEmailTemplates), send_email_1.communicationSendEmail), send_message_1.communicationSendMessage), send_sms_1.communicationSendSms), send_templated_email_1.communicationSendTemplatedEmail), shipment_info_1.deliveryTrackingShipmentInfo), synthesis_1.speechSynthesis), character_information_1.starwarsCharacterInformation), pull_request_1.vcsPullRequest), pull_requests_1.vcsPullRequests), single_file_content_1.vcsSingleFileContent), user_repos_1.vcsUserRepos), current_city_1.weatherCurrentCity);
