...
describe('vcs/single-file-content/gitlab', () => {
    it('performs correctly', async () => {
        ...
        await expect(useCase.perform({ owner: 'Jakub-Vacek', repo: 'empty-test', path: 'README.md', ref: 'master' }, { provider })).resolves.toEqual(ok({ content: expect.any(String), encoding: 'base64', size: expect.any(Number) }))
    })
})
