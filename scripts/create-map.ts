import { CAPABILITIES_DIR, EXTENSIONS, SUPER_JSON, PROFILE_BUILD_DIR } from "./constants";
...
async function createMap() {
    ...
    //Create map file
    await writeFile(`./${CAPABILITIES_DIR}/${scope}/${usecase}/maps/${mapName}${EXTENSIONS.map.source}`, mapTemplate(scope, usecase, mapName));

    //Create test for map file
    await writeFile(`./${CAPABILITIES_DIR}/${scope}/${usecase}/maps/${mapName}.test.ts`, mapTestTemplate(scope, usecase, mapName));
