import { CAPABILITIES_DIR, EXTENSIONS, SUPER_JSON, PROFILE_BUILD_PATH } from "./constants";
...
async function createProfile() {
    ...
    //Create profile file
    await writeFile(`./${CAPABILITIES_DIR}/${scope}/${usecase}/profile${EXTENSIONS.profile.source}`, profileTemplate(usecase, scope));
